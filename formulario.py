...
Original file is located at
    https://colab.research.google.com/drive/1HpUn0EZcV7OutQE4D6XWPOmHCQ5-Ct7I

# **El cuerpo de mi formulario.**
"""
...
"""# **Instalación del paquete para poder obtener el enlace del sitio Web.**"""

!pip install streamlit pyngrok

from pyngrok import ngrok

# Configura tu token de ngrok (reemplázalo con el tuyo)
ngrok.set_auth_token("2wJtARRMTi7xeGzduckk3ndQGBC_3aRBHfr1uPsHq2AcYJXda")

# Inicia Streamlit en segundo plano (puerto 8500 por defecto)
!streamlit run app.py --server.port 8500 &>/dev/null &

# Abre un túnel HTTP hacia el puerto 8500
public_url = ngrok.connect(addr="8500", proto="http")
print("Tu aplicación Streamlit está disponible en:", public_url.public_url)